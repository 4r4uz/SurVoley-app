...
interface ListBaseProps<T, F = FiltrosBase> {
  items: T[];
  loading: boolean;
  filtros: F;
  setFiltros: (filtros: F) => void;
...
export default function ListBase<T>({
  items,
  loading,
  filtros,
  setFiltros,
        ...
        {items.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtitle}>
              {filtros.busqueda ? 'Intenta con otros filtros de búsqueda' : 'No hay elementos registrados'}
            </Text>
          </View>
        ) : (
