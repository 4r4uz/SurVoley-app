    ...
    <SafeLayout>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl
            ...
            onRefresh={onRefresh}
            colors={[colors.entrenador]}
            tintColor={colors.entrenador}
            title="Actualizando..."
            titleColor="#6B7280"
          />
        }
      >
        ...
        >
          <View style={styles.sectionHeader}>
            <View style={styles.sectionTitleContainer}>
              <Ionicons name="time" size={20} color={colors.entrenador} />
          ...
          {loading ? (
            <View style={styles.loadingContainer}>
                ...
                <Ionicons name="refresh" size={32} color={colors.entrenador} />
              </View>
        ...
        >
          <View style={styles.sectionHeader}>
            <View style={styles.sectionTitleContainer}>
              <Ionicons name="flash" size={20} color={colors.entrenador} />
