...
export default function ApoderadoCertificadoScreen() {
  const { user } = useAuth();
  ...
  const cargarCertificados = async () => {
    try {
      ...
      // Obtener certificados de los hijos
  ...
  const getTipoColor = (tipo: string) => {
    switch (tipo) {
      ...
      default: return colors.apoderado;
    }
  };
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.certificadosList}>
          <View style={styles.listHeader}>
            <Text style={styles.listTitle}>Certificados de tus hijos</Text>
          ...
          {certificados.length === 0 && (
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyDescription}>
                No se encontraron certificados para tus hijos
              </Text>
            </View>
          )}
        </View>
